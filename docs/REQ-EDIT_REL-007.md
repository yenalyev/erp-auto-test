...
| Часова межа | TC-REL-DATE-001…017, TC-REL-091 | `RelocationOneDayLimitTest`, `RelocationInTransitEditTest` — обмеження для всіх нащадків TSUK; ієрархія без TSUK та null parent без нижньої межі; прийняття без обмеження дати |
