...
| AC-06 | На «В дорозі» олівець у відправника (і в адміна) лише при конкретній обраній локації; у отримувача його немає; після прийняття рядок зникає. Без обраної локації або на чужій локації олівця немає, «Прийняти»/«Скасувати» disabled з тултіпом; банера «Оновіть сторінку» немає. На складі отримувача «Прийняти» активна. |
