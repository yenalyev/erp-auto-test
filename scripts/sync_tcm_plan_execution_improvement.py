...
core.ACCEPTANCE_CRITERIA = [
    ("AC-01", "Категорійний мультиселект фільтрує planned і out-of-plan; батьківська категорія включає нащадків та комбінується з пошуком і favourites."),
    ...
    ("AC-06", "Агрегація виконується за resourceId + snapshot unit; назва й категорія беруться з актуального ресурсу, зміна unit створює окремий рядок і стара unit не закриває нову ціль."),
]
...
core.CASES = [
    ...
    case("TC-API-RES-007", "AC-06", "ADMIN змінює одиницю ресурсу", "Створити productions до і після зміни unit та план у новій unit.", "PUT дозволений; execution має два unit buckets, стара unit не закриває нову ціль."),
    ...
    case("TC-UI-PLANEXEC-022", "AC-01", "Батьківська категорія включає нащадків", "Обрати parent на сторінці й у popup.", "Усі дочірні ресурси включені."),
    ...
    case("TC-UI-PLANEXEC-025", "AC-05", "Planned після архівування ресурсу", "Архівувати техкарту і ресурс після productions.", "Зроблено й Excel не змінюються."),
    case("TC-UI-PLANEXEC-026", "AC-05", "Out-of-plan після архівування", "Архівувати out-of-plan resource.", "Історичний total і рядок лишаються."),
    ...
    case("TC-UI-PLANEXEC-028", "AC-06", "Історичні metadata та unit buckets", "Змінити name/category/unit між productions.", "Останні name/category, окремі рядки лише за unit."),
]
